...
### Discussion
At the beginning of our project we were presented with the issue of designing and implementing a hotel reservation system. The owners and staff of the company explained through series of interviews and meetings that the current system is clunky, inefficient, and hard to navigate. This led us to create some of our goals for the project. We wanted our project to have the following attributes: User-Friendly Experience, Efficient Admin Tools, Secure Payment System, Real-Time Availability, and Booking Flexibility. These project objectives if met, would increate the hotel's productivity by a significant margin. We began by creating a user login and registration system that was clear and easy to understand as well as secure and encrypted to ensure user data safety. We then completed a room management system that shows users the floorplan of the hotel and allows them to individually select rooms and determine availability as well as price and size. Finally, we implemented a simple and easy to comprehend online room reservation process. This process checks to make sure that the room is available and aims to prevent double booking and inconsistencies with registration times. We developed these requirements with the Agile SDLC to increase company feedback as well as to help facilitate iterative develpoment. After implementing our features, we were able to gain feedback from the company and make any neccessary changes to the software. We believe that this new and improved hotel reservation system will not only increase profits and efficiency for the company, but also increase willingness and readiness for users to use the software due to the increase simplicity and ease of use. 
### Conclusion
